...
class CameraTracker:
    ...
    def __init__(self, camera_id):
        ...
        # Tracking parameters
        self.CONTOUR_UPDATE_INTERVAL = 0.5
        self.DISTANCE_THRESHOLD = 5
    
    def get_center(self, contour):
        """Return a modified center: central X, matched Y from contour points"""
        x_coords = [pt[0][0] for pt in contour]
        y_coords = [pt[0][1] for pt in contour]
        ...
        # Find all points in contour with closest X to center_x
        closest_points = sorted(contour, key=lambda pt: abs(pt[0][0] - center_x))
        closest_y = closest_points[0][0][1]

        return (center_x, closest_y)
    
    def contours_similar(self, c1, c2, pos_thresh=90, area_thresh=0.2):
...
class CoagulexApp:
    ...
    def setup_video(self):
        ...
        self.vidCap1 = cv.VideoCapture(r"C:\Users\adide\Downloads\Screencast from 2025-06-12 11-18-55.mp4")
        self.vidCap2 = cv.VideoCapture(0)
    ...
    def update_video(self):
        ...
        if ret1:
            if self.monitoring_active:
                ...
                gray1 = binarize_grayscale(gray1, threshold=50) # ← add quantization here
        ...
        if ret2:
            if self.monitoring_active:
                ...
                gray2 = binarize_grayscale(gray2, threshold=50)
